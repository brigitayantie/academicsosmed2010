...
$objTeman = new Profile("$id"); //88888 harusnya pakai session
...
<script language="javascript" src="script/cattTeman.js" type="text/javascript"></script>
...
<script type="text/javascript" src="script/pesan.js"></script>
          ...
          <? include "script/Auto_suggestion/auto.htm"; ?>
                ...
                <div class="art-contentLayout">
                    <div class="art-sidebar1">
                        <? include 'content/fotoTeman.php'; ?>
                         <? include 'content/infoKiriTeman.php'; ?>

                    </div>
                    <div class="art-content">
                        <? include 'content/kirimPesan.php'; ?>
