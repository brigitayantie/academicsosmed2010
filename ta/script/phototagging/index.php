...
<div id="title_container" class="hide">
	...
	<img src="images/image.jpg" border="0" id="imageid" /><br /><br />
<?php
		$list_tags = array();
...
<p>In this photo:
	<?php
		foreach ($list_tags as $value) {
			echo "<a href='".str_replace(' ', '-',$value['title'])."'>".$value['title']."</a> (<a href='includes/function.php?delete=true&id=".$value['id']."'>Delete</a>)&nbsp;&nbsp;";
		}
	?>
</p>
