	...
	xmlhttp.onreadystatechange = function() 
	{
		if (xmlhttp.readyState == 4) {
			...
			if (xmlhttp.status == 200) {
				...
				document.getElementById("tampilCattTeman").innerHTML = hasil;
...
//
var xmlhttp = GetXMLHTTP ("POST", "ajax/tampilSmwCatatanTeman.php", params);
	...
	xmlhttp.onreadystatechange = function() 
	{
		if (xmlhttp.readyState == 4) {
			...
			//document.getElementById("tampilCattTeman").style.display="none";
			document.getElementById("tampilCattTeman").innerHTML=hasil;
		//document.getElementById("tampilHasil").innerHTML = hasil;
