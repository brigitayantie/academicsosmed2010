...
function cariJadwalAjar()
{

	varSemester = document.getElementById("semesterAjar").value;
	
var params = "semester=" + varSemester;
	
var xmlhttp = GetXMLHTTP ("POST", "ajax/cariJadwalAjar.php", params);
	...
	xmlhttp.onreadystatechange = function() 
	{
		if (xmlhttp.readyState == 4) {
			...
			if (xmlhttp.status == 200) {
				...
				document.getElementById("tampilJadwalAjar").innerHTML = hasil;
