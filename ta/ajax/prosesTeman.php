...
$sql = mysql_query("UPDATE tgsakhir.teman t SET t.status='terima' WHERE t.id_obyek='$masterAmbilSemua[id_user]' AND t.id_subyek=$teman");
else
$sql = mysql_query("UPDATE tgsakhir.teman t SET t.status='tolak' WHERE t.id_obyek='$masterAmbilSemua[id_user]' AND t.id_subyek=$teman");
