...
<script language="javascript" src="script/tambahBagian.js" type="text/javascript"></script>
<script language="javascript" src="script/editBagian.js" type="text/javascript"></script>
...
<script language="javascript" src="script/editUser.js" type="text/javascript"></script>
    ...
    <title>Tambah dan Edit Bagian</title>
...
var ajaxwin=dhtmlwindow.open("box", "iframe", "http://localhost/ta/admin/tambahBagian.php", "Tambah Bagian", "width=590px,height=350px,resize=1,scrolling=1,center=1", "recal")

ajaxwin.onclose=function()
{return window.confirm("Tutup jendela tambah bagian?")} //Run custom code when window is about to be closed
...
<p> <div align="center">
                                            	<span class="art-button-wrapper" >
                                            		<span class="l"> </span>
                                            		<span class="r"> </span>
                                            		<a class="art-button" onclick="javascript: tambahBagian();" >Simpan</a>
                                            	</span>
                                                </div>
                                            </p>
