...
var ajaxwin=dhtmlwindow.open("box", "iframe", "http://localhost/ta/admin/tambahDosen.php", "Tambah Dosen", "width=590px,height=350px,resize=1,scrolling=1,center=1", "recal")

ajaxwin.onclose=function()
{return window.confirm("Tutup menu tambah dosen?")} //Run custom code when window is about to be closed

}

function openpageMhs()
{ //Define arbitrary function to run desired DHTML Window widget codes
//ajaxwin=dhtmlwindow.open("ajaxbox", "ajax", "windowfiles/external.htm", "#3: Ajax Win Title", "width=450px,height=300px,left=300px,top=100px,resize=1,scrolling=1")

var ajaxwin=dhtmlwindow.open("box", "iframe", "http://localhost/ta/admin/tambahMhs.php", "Tambah Mahasiswa", "width=590px,height=350px,resize=1,scrolling=1,center=1", "recal")

ajaxwin.onclose=function()
{return window.confirm("Tutup menu tambah Mahasiswa?")} //Run custom code when window is about to be closed
            ...
            <div class="art-Sheet-body">
                <div class="art-nav">
                	...
                	<div class="r"></div>
                        ...
                        <li>
                			<a href="editUser.php" class=" active"><span class="l"></span><span class="r"></span><span class="t">User</span></a>
...
<input type="hidden" id="tampungJurusan" />
                                          ...
                                          <tr>
                                          <td>
                                          <a href="#" onclick="javascript : tampilSemua();"> Tampil Semua</a>
                                          </td>
                                          <td><select onchange="javascript:stlhPeran();" name="cmbPeran" id="cmbPeran">
