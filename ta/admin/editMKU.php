...
<script language="javascript" src="script/editUser.js" type="text/javascript"></script>
    ...
    <title>Tambah dan Edit MKU</title>
...
var ajaxwin=dhtmlwindow.open("box", "iframe", "http://localhost/ta/admin/tambahMKU.php", "Tambah MKU", "width=590px,height=350px,resize=1,scrolling=1,center=1", "recal")

ajaxwin.onclose=function()
{return window.confirm("Tutup menu tambah MKU?")} //Run custom code when window is about to be closed
                  ...
                  <div class="art-content">
                      <div class="art-Post">
                        ...
                        <div class="art-Post-inner">
                                       ...
                                       <span id="tampilAwal"> <? include "ajax/tampilMKU.php"; ?>  </span>
