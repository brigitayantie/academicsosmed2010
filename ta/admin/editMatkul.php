...
var ajaxwin=dhtmlwindow.open("box", "iframe", "http://localhost/ta/admin/tambahMatkul.php", "Tambah Mata Kuliah", "width=590px,height=350px,resize=1,scrolling=1,center=1", "recal")

ajaxwin.onclose=function()
{return window.confirm("Tutup menu tambah Mata Kuliah?")} //Run custom code when window is about to be closed

}
   
</script>
<body>
<input type="hidden" id="lokasi" value="matkul" />
...
<input type="hidden" id="tampungJurusan" />
                                          <div align='center'>Anda dapat <a  href='#' onclick='javascript:openMatkul(); return false;'>menambah</a> dan mengedit data mata kuliah pada form berikut</div>
                                         </div><br /><br />
                                          <table border="0">
                                          <tr>
                                          <td>
                                          ...
                                          <td><input type="hidden" id="page" value="1" /><select onchange="javascript:ubahCmbJurusan();" name="fakultas" id="fakultas">
                                                  <?
