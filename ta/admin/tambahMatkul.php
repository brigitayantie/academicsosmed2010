            ...
            <div class="art-Sheet-body">
                <div class="art-nav">
                	...
                	<ul class="art-menu">
                        ...
                        <li>
                			<a href="#" class="active"><span class="l"></span><span class="r"></span><span class="t">Mata Kuliah Jurusan</span></a>
                			<ul>
                                          ...
                                          <div align="center">Anda dapat menambah data mahasiswa pada form berikut</div><br /><br />
                                            <table align="center" width="51%" border="0" cellspacing="1" cellpadding="1">
                                              ...
                                              <tr>
                                                ...
                                                <td>&nbsp;</td>
                                                <td><input type="text" id="namaMatkul" name="nama_matkul" maxlength="30" />                                                  <span style="color:#F00" id="err_matkul"></span>
                                                </td>
                                              </tr>
                                                <td>&nbsp;</td>
                                                <td>&nbsp;</td>
                                            ...
                                            <p> <div align="center">
                                            	<span class="art-button-wrapper" >
                                            		<span class="l"> </span>
                                            		<span class="r"> </span>
                                            		<a class="art-button" onclick="javascript: tambahMatkul();">Simpan</a>
                                            	</span>
                                                </div>
                                            </p>
