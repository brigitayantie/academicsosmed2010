...
function editRuang(id)
{
	...
	document.getElementById("spanNamaRuang["+id+"]").style.display="none";
	document.getElementById("txtNamaRuang["+id+"]").style.display="inline";
	document.getElementById("edit["+id+"]").style.display="none";
	document.getElementById("simpan["+id+"]").style.display="inline";
}

function BatalRuang(id)
{
	document.getElementById("spanNamaRuang["+id+"]").style.display="inline";
	document.getElementById("txtNamaRuang["+id+"]").style.display="none";
...
// JavaScript Document
function edit2Ruang(idx)
{
	idRuangSblm = document.getElementById("spanIdRuang["+idx+"]").innerHTML;
 
 
ruang = document.getElementById("txtNamaRuang["+idx+"]").value;


var params = "ruang=" + ruang
//+ "&idx=" + varIdx 
+ "&idRuangSblm=" + idRuangSblm ;

 var xmlhttp = GetXMLHTTP("POST","ajax/edit2Ruang.php",params); // relative terhadap penginclude (admin/index.php)
...
xmlhttp.onreadystatechange = function() 
	{
		...
		if (xmlhttp.readyState == 4) {
			...
			if (xmlhttp.status == 200) {
				...
				document.getElementById("spanNamaRuang["+idx+"]").innerHTML =
					document.getElementById("txtNamaRuang["+idx+"]").value;
...
function hapusRuang(varIdRuang)
{
...
if (r==false)
  ...
  return false;
	...
	var params = "idRuang=" + IdRuang;

var xmlhttp = GetXMLHTTP ("POST", "ajax/hapusRuang.php", params);
