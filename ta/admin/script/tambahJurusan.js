...
function replaceDoc()
{
	document.getElementById("fakultas").value=0;
	document.getElementById("idJur").innerHTML="";
	document.getElementById("jur").innerHTML="";
   ...
   if(xmlhttp.status == 200)
     {
       ...
       if(hasil == "0")
       {
		   document.getElementById("tampilHasil").innerHTML = "Berhasil input";
